...
define view entity YSAN_I_PO_I as select from ysan_order_i
association to parent YSAN_I_PO_H as _order on $projection.PurchaseOrder = _order.PurchaseOrder
{
